...
class ModelData(BaseModel):
    ...
    explanatory_variables: Optional[List[Timeseries]] = Field(
        default=None,  # Если указать не None, то в запросах где не указываются экзогенные переменные добавляется
                       # наш случайный шум, тем более месячной частотности, а может быть ежедневная
